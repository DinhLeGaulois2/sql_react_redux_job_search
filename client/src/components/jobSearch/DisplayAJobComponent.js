...
const statusConverter = (expr) => {
    if (expr == jobSearchCst.SET_PENDING) return "Show Pending"
    else if (expr == jobSearchCst.SET_MISSED) return "Show Missed"
    else if (expr == jobSearchCst.SET_RECENT_FIRST) return "Most Recents First"
    else if (expr == jobSearchCst.DISPLAY_LIST) return "Show All"
    return ""
}
    ...
    render() {
        ...
        return (
            <div>
                ...
                {displayStatus == jobSearchCst.UPDATE && jobs.length == 1 &&
                    <Modal>
                        <div className="panel panel-success">
                            <div className="panel-heading">
                ...
                {displayStatus != jobSearchCst.DISPLAY_ONE && jobs.length > 0 &&
                    <div>
